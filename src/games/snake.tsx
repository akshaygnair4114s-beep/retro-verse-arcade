  ...
  return (
    <div className="grid gap-6 md:grid-cols-[1fr_auto] items-start">
      <div className="mx-auto w-full max-w-md md:max-w-none">
        <div
          className="relative mx-auto inline-block rounded-lg p-2 bg-black/60 ring-1 ring-neon-green/30 touch-none select-none"
          style={{ boxShadow: "0 0 30px oklch(0.85 0.22 145 / 0.25)" }}
        >
          <div
            className="grid relative grid-bg"
            style={{ gridTemplateColumns: `repeat(${SIZE}, ${cellPx})`, gap: 1 }}
          >

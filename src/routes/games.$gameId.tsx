  ...
  errorComponent: ({ error, reset }) => (
    <div className="min-h-screen grid place-items-center p-6 text-center">
      <div>
        ...
        <button className="btn-ghost-neon mt-4" onClick={reset}>
          Retry
        </button>
      </div>
    </div>
    ...
    <div className="relative z-10 min-h-screen flex flex-col">
      ...
      <main className="flex-1 grid place-items-center p-6 text-center">
        <div>
          ...
          <h1 className="mt-3 font-display text-4xl font-black neon-text-magenta">
            Cabinet not installed yet
          </h1>
          <p className="mt-3 text-muted-foreground max-w-md mx-auto">
            This game is on the roadmap but not playable yet. Check the arcade for what's live
            tonight.
          </p>
          <Link to="/games" className="btn-neon mt-6 inline-flex">
            ← Back to arcade
          </Link>
        </div>
      </main>
      ...
      <main className="mx-auto w-full max-w-6xl px-3 sm:px-6 py-6 sm:py-8 flex-1">
        ...
        <nav className="mb-4" aria-label="Breadcrumb">
          <ol className="flex items-center text-xs text-muted-foreground">
            ...
            <li>
              <Link to="/games" className="hover:text-neon-cyan transition-colors">
                Games
              </Link>
            </li>
            <li className="mx-2">/</li>
        ...
        <div className="grid grid-cols-[minmax(0,1fr)_auto] sm:flex sm:flex-wrap sm:items-center sm:justify-between gap-3 sm:gap-4 mb-5 sm:mb-6">
          <div className="min-w-0">
            <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-black neon-text-cyan truncate">
              {game.name}
            </h1>
        ...
        <div className="glass rounded-2xl p-3 sm:p-4 md:p-6 ring-1 ring-white/10 overflow-hidden">
          {!game.available ? (
            ...
            <Suspense
              fallback={
                <div className="aspect-video grid place-items-center text-neon-cyan font-mono">
                  Loading cabinet…
                </div>
              }
            >
          ...
          <section className="mt-8 space-y-6">
            ...
            <div className="glass rounded-xl p-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Our version features smooth 60 FPS gameplay, responsive controls, and saves your
    ...
    <div className="aspect-video grid place-items-center text-center p-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          This cabinet is being wired up. More games are being added — stay tuned.
        </p>
      </div>
    </div>
  );
